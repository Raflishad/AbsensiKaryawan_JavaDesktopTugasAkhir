 ...
 */
public class adminDataPegawai extends javax.swing.JFrame {
    Connection conn;
    DefaultTableModel model;
    /**
     * Creates new form Admin
     */
    public adminDataPegawai() {
        initComponents();
...
//            model.addColumn("Hapus");
        ...
        try {
            ...
            ResultSet rs = stmt.executeQuery("SELECT P.*, J.NAMA_JABATAN, B.NAMA_BAGIAN FROM PEGAWAI P LEFT JOIN JABATAN J ON P.ID_JABATAN=J.ID_JABATAN LEFT JOIN BAGIAN B ON P.ID_BAGIAN=B.ID_BAGIAN");
   ...
   int selectedRow = jTable1.getSelectedRow();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(adminDataPegawai.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new adminDataPegawai().setVisible(true);
            }
        });
    }
